...
if __name__ == "__main__":
    ...
    zoom_factor = 0.25
    filename = 'result_sfa__FoT_18fJ2k.npy'
    ...
    # sfa in layer 1
    sfa_node_1a = mdp.nodes.SFANode( input_dim = switchboard_1.out_channel_dim,
                                     output_dim = 32 )
    expansion_1 = mdp.nodes.QuadraticExpansionNode( input_dim = sfa_node_1a.output_dim )
    sfa_node_1b = mdp.nodes.SFANode( input_dim = expansion_1.output_dim,
                                     output_dim = 32 )
    sfa_node_1 = mdp.hinet.FlowNode( mdp.Flow([ sfa_node_1a, expansion_1, sfa_node_1b ]) )
    ...
    # sfa in layer 2
    sfa_node_2a = mdp.nodes.SFANode( input_dim = switchboard_2.out_channel_dim,
                                     output_dim = 32 )
    expansion_2 = mdp.nodes.QuadraticExpansionNode( input_dim = sfa_node_2a.output_dim )
    sfa_node_2b = mdp.nodes.SFANode( input_dim = expansion_2.output_dim,
                                     output_dim = 32 )
    sfa_node_2 = mdp.hinet.FlowNode( mdp.Flow([ sfa_node_2a, expansion_2, sfa_node_2b ]) )
    ...
    # final sfa step
    sfa_node_Xa = mdp.nodes.SFANode( input_dim = sfa_layer_3.output_dim,
                                     output_dim = 32 )
