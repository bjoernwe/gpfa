...
algorithm_parameters = {eb.Algorithms.PFA: {env_data.Datasets.STFT1: {'p': 10, 'K': 10},
                                            ...
                                            env_data.Datasets.STFT3: {'p': 1, 'K': 0},
                                            env_data.Datasets.EEG2: {'p': 10, 'K': 1},
                                            env_data.Datasets.EEG: {'p': 8, 'K': 2},
                                            ...
                                            env_data.Datasets.HAPT: {'p': 4, 'K': 0}},
                        eb.Algorithms.GPFA2: {env_data.Datasets.STFT1: {'p': 4, 'k': 5},
                                              env_data.Datasets.STFT2: {'p': 4, 'k': 1},
                                              env_data.Datasets.STFT3: {'p': 1, 'k': 5},
                                              env_data.Datasets.EEG2: {'p': 1, 'k': 5},
                                              env_data.Datasets.EEG: {'p': 4, 'k': 5},
                                              env_data.Datasets.EIGHT_EMOTION: {'p': 2, 'k': 2},
                                              env_data.Datasets.PHYSIO_EHG: {'p': 4, 'k': 10},
                                              env_data.Datasets.PHYSIO_MGH: {'p': 1, 'k': 2},
