...
algorithm_parameters = {eb.Algorithms.PFA: {env_data.Datasets.STFT1: {'p': 10, 'K': 10},
                       						...
                       						env_data.Datasets.STFT3: {'p': 1, 'K': 10},
                       						env_data.Datasets.EEG2: {'p': 10, 'K': 0},
                       						env_data.Datasets.EEG: {'p': 6, 'K': 1},
                       						...
                       						env_data.Datasets.PHYSIO_UCD: {'p': 8, 'K': 1},
                       						...
                       						None: {'p': 6, 'K': 10}},
                        eb.Algorithms.GPFA2: {env_data.Datasets.STFT1: {'p': 4, 'k': 5},
                       						  env_data.Datasets.STFT2: {'p': 6, 'k': 1},
                       						  env_data.Datasets.STFT3: {'p': 8, 'k': 1},
                       						  env_data.Datasets.EEG2: {'p': 1, 'k': 10},
                       						  env_data.Datasets.EEG: {'p': 8, 'k': 5},
